...
?>
		...
		<td><a href="<?php echo $this->buildLink('pictures/edit/' . $row['ID']); ?>"> Edit </a></td>
		<td><a href="<?php echo $this->buildLink('pictures/getCommentars/' . $row['ID']); ?>"> Commentars </a></td>
		<td><a class="danger" href="<?php echo $this->buildLink('pictures/delete/' . $row['ID']); ?>"> Delete </a></td>
	    </tr>
<?php
        }
?>
