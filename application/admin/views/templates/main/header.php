...
<html lang="en">
    ...
    <link href="<?php echo $this->path_template;?>css/simple-sidebar.css" rel="stylesheet">    
    <section>
...
?>
			...
			<ul class="dropdown-menu" role="menu">
			    ...
			    <li><a href="<?php echo $this->buildLink('../home/index');?>">Logout from admin panel</a></li>	    
...
<div class="container-fluid">   
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="nav nav-pills nav-stacked padding-10">
                    <li><a href="<?php echo $this->buildLink('home/index');?>"> Home </a></li>
                    <li><a href="<?php echo $this->buildLink('pictures/index');?>">Pictures</a></li>
                    <li><a href="<?php echo $this->buildLink('users/index');?>">Users</a></li>
                </ul>
        </div>
